...
object DatabaseMigrations {
    ...
    /** Migrations that predate device-independent read-record identities require the legacy id. */
    fun migrations(legacyAndroidId: String): Array<Migration> =
        arrayOf(
            migration_10_11, migration_11_12, migration_12_13, migration_13_14,
            migration_14_15, migration_15_17, migration_17_18, migration_18_19(legacyAndroidId),
    ...
    /** Test/default list for migrations that do not execute the legacy 18→19 step. */
    val migrations: Array<Migration>
        get() = migrations(legacyAndroidId = "")
    ...
    private fun migration_18_19(legacyAndroidId: String) = object : Migration(18, 19) {
        override fun migrate(database: SupportSQLiteDatabase) {
            database.execSQL(
            ...
            database.execSQL("INSERT INTO readRecordNew(androidId, bookName, readTime) select '$legacyAndroidId' as androidId, bookName, readTime from readRecord")
