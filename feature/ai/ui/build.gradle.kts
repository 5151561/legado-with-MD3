...
android {
    namespace = "io.legado.app.feature.ai.ui"
}
dependencies {
    api(project(":feature:ai:api")); implementation(project(":core:designsystem"))
    ...
    implementation(libs.kotlinx.collections.immutable); implementation(libs.kotlinx.coroutines.android)
